...
<script type="text/javascript" src="/application/views/backend/lib/datatables/1.10.0/jquery.dataTables.min.js"></script> 
<script type="text/javascript" src="/application/views/backend/lib/laypage/1.2/laypage.js"></script>
    ...
    "columns": [
        ...
        {  
            ...
            render : function(data, type, full) {  
                var operate = '<a style="text-decoration:none" href="javascript:;" onClick="picture_stop(this, '+full.id+')" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a>';  
                operate += '<a style="text-decoration:none" class="ml-5" href="javascript:;" onClick="picture_edit(\'图库编辑\',\'./image/image_add\','+full.id+')" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>';  
                operate += '<a style="text-decoration:none" class="ml-5" href="javascript:;" onClick="picture_del(this,'+full.id+')" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>';
                return operate;  
            }   
        }
    ],
